...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='rendered', help='chooses how datasets are loaded. [rendered | unaligned | aligned | single]')
        parser.add_argument('--model', type=str, default='render_gan', help='chooses which model to use. render_gan, cycle_gan, pix2pix, test')
