...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='masked', help='chooses how datasets are loaded. [masked | unaligned | aligned | single]')
        parser.add_argument('--model', type=str, default='render_net', help='chooses which model to use. render_net, cycle_gan, pix2pix, test')
